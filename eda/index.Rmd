...
selectInput("County", label = "Select County", choices = county_list)
counties_plot

#mainPanel(counties_plot, renderPlot({
#  plot_ly(data = input$County, x = ~Immunization_Percentage, y = ~School_District,
#          name = "Immunization Rate in each District",
